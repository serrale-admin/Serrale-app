...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', gap: 12, alignItems: 'flex-start', backgroundColor: colors.surface, borderWidth: 1, borderColor: 'rgba(6,71,52,0.09)', borderRadius: radius.lg + 2, padding: 14, ...shadowCard, shadowOpacity: 0.04 },
